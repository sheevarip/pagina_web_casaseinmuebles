			...
			foreach($mene as $roww){
              ...
              <h3 class="box-title">AMENIDADES</h3>
                ...
                <!--<label>
                  ...
                  <input type="checkbox" class="minimal" name="cesion" value="1" id="cesion" >
               Cesión de Derechos
...
foreach($mend as $rowr){
                ...
                <label>
                  ...
                  <input type="checkbox" class="minimal" name="escrituras" value="1" id="escrituras">
                 Escrituras Públicas
                </label>
               ...
               Cesión de Derechos
                ...
                <label>
                  ...
                  <input type="checkbox" class="minimal" name="jardin" id="jardin" value="1" >
                  Jardin
                ...
                <label>
                  <input type="checkbox" class="minimal" name="cochera" value="1" id="cochera" >
                  Cochera
                </label>
				</div>  
                ...
                <label>
                  <input type="checkbox" class="minimal" name="alberca" value="1" id="alberca" >
                 Alberca
                </label>
				</div>
                ...
                <label>
                  <input type="checkbox" class="minimal" name="cisterna" value="1" id="cisterna" >
                Cisterna
                </label>
				</div>
                ...
                <label>
                  <input type="checkbox" class="minimal" name="estacionario" value="1" id="estacionario" >
                Gas Estacionario
                </label>
				</div>
                ...
                <label>
                  <input type="checkbox" class="minimal" name="pavimentado" value="1" id="pavimentado" >
                Pavimentado
                </label>
				</div>
					<!-- ***internet** -->
                ...
                <label>
                  <input type="checkbox" class="minimal" name="internet" value="1" id="internet" >
               Internet
                </label>
				</div>
					<!-- ***aire acondicionado** -->
                ...
                <label>
                  <input type="checkbox" class="minimal" name="aire" value="1" id="aire" >
               Aire acondicionado
                </label>
				</div>
                ...
                <label>
                  <input type="checkbox" class="minimal" name="amueblado" value="1" id="amueblado" >
               Amueblado
                </label>
				</div>
				<!-- ***calefaccion** -->
                ...
                <label>
                  <input type="checkbox" class="minimal" name="calefaccion" value="1" id="calefaccion" >
               Calefacción
                </label>
				</div>
                ...
                <label>
                  <input type="checkbox" class="minimal" name="piscina" value="1" id="piscina" >
               Piscina
                </label>
				</div>
			<!-- ***television** -->
                ...
                <label>
                  <input type="checkbox" class="minimal" name="television" value="1" id="television" >
               Televisión/Cable
                </label>
				</div>
				<!-- ***azotea** -->
                ...
                <label>
                  <input type="checkbox" class="minimal" name="azotea" value="1" id="azotea" >
				Azotea
                </label>
				</div>
				<!-- ***terraza** -->
                ...
                <label>
                  <input type="checkbox" class="minimal" name="terraza" value="1" id="terraza" >
				Terraza
                </label>
				</div>
				<!-- ***seguridad** -->
                ...
                <label>
                  <input type="checkbox" class="minimal" name="seguridad" value="1" id="seguridad" >
				Seguridad
                </label>
				</div>
				<!-- ***camara** -->
                ...
                <label>
                  <input type="checkbox" class="minimal" name="camara" value="1" id="camara" >
				Camara de Seguridad
                </label>
				</div>
				<!-- ***cocina** -->
                ...
                <label>
                  <input type="checkbox" class="minimal" name="cocina" value="1" id="cocina" >
				Cocina
                </label>
				</div>
                ...
                <label>
                  <input type="checkbox" class="minimal" name="propio" value="1" id="propio" >
				Baño Propio
                </label>
				</div>
					<!-- ***baño compartido** -->
                ...
                <label>
                  <input type="checkbox" class="minimal" name="compartido" value="1" id="compartido" >
				Baño Compartido
                </label>
				</div>
           ...
           <div class="form-group" id="foto_principal" style="display:none;" >          
                <label for="exampleInputFile">Subir Foto Principal</label>
                    <input id="file-1" type="file" class="file" name="foto_principal[]" id="foto_principal"  data-preview-file-type="any">
  ...
  <div class="box-footer" id="submit" style="display:none;">
      ...
      <!-- /.row -->
    	...
    	<div id="msglogin" class="'.$Class.'">'.$Error.$Errorr.$Error_fp.'</div>
    <!-- /.content -->
  </div>';
